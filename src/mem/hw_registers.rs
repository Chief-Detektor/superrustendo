...
impl HWRegister {
    ...
    pub fn get_component(&self) -> BusComponent {
        match self {
            ...
            HWRegister::BG1HOFS_M7HOFS => BusComponent::PPU,
            HWRegister::BG1VOFS_M7VOFS => BusComponent::PPU,
            HWRegister::BG2HOFS => BusComponent::PPU,
            HWRegister::BG2VOFS => BusComponent::PPU,
            HWRegister::BG3HOFS => BusComponent::PPU,
    ...
    pub fn get_type(&self) -> Type {
        match self {
            ...
            HWRegister::BG1HOFS_M7HOFS => Type::W8x2,
            HWRegister::BG1VOFS_M7VOFS => Type::W8x2,
            HWRegister::BG2HOFS => Type::W8x2,
            HWRegister::BG2VOFS => Type::W8x2,
            HWRegister::BG3HOFS => Type::W8x2,
    ...
    pub fn get_register(address: u16) -> Option<HWRegister> {
        match address {
            ...
            0x210d => Some(HWRegister::BG1HOFS_M7HOFS),
            0x210e => Some(HWRegister::BG1VOFS_M7VOFS),
            0x210f => Some(HWRegister::BG2HOFS),
            0x2110 => Some(HWRegister::BG2VOFS),
            0x2111 => Some(HWRegister::BG3VOFS),
            0x2112 => Some(HWRegister::BG4HOFS),
            0x2113 => Some(HWRegister::BG4HOFS),
            0x2114 => Some(HWRegister::BG4VOFS),
            0x2115 => Some(HWRegister::VMAIN),
            0x2116 => Some(HWRegister::VMADDL),
            0x2117 => Some(HWRegister::VMADDH),
            0x2118 => Some(HWRegister::VMDATAL),
            0x2119 => Some(HWRegister::VMDATAH),
            0x211a => Some(HWRegister::M7SEL),
            0x211b => Some(HWRegister::M7A),
            0x211c => Some(HWRegister::M7B),
            0x211d => Some(HWRegister::M7C),
            0x211e => Some(HWRegister::M7D),
            0x211f => Some(HWRegister::M7X),
            0x2120 => Some(HWRegister::M7Y),
            0x2121 => Some(HWRegister::CGADD),
            0x2122 => Some(HWRegister::CGDATA),
            0x2123 => Some(HWRegister::W12SEL),
            0x2124 => Some(HWRegister::W34SEL),
            0x2125 => Some(HWRegister::WOBJSEL),
            0x2126 => Some(HWRegister::WH0),
            0x2127 => Some(HWRegister::WH1),
            0x2128 => Some(HWRegister::WH2),
            0x2129 => Some(HWRegister::WH3),
            0x212a => Some(HWRegister::WBGLOG),
            0x212b => Some(HWRegister::WOBJLOG),
            0x212c => Some(HWRegister::TM),
            0x212d => Some(HWRegister::TS),
            0x212e => Some(HWRegister::TMW),
            0x212f => Some(HWRegister::TSW),
            0x2130 => Some(HWRegister::CGWSEL),
            0x2131 => Some(HWRegister::CGADSUB),
            0x2132 => Some(HWRegister::COLDATA),
            0x2133 => Some(HWRegister::SETINI),
            0x2134 => Some(HWRegister::MPYL),
            0x2135 => Some(HWRegister::MPYM),
            0x2136 => Some(HWRegister::MPYH),
            0x2137 => Some(HWRegister::SLHV),
            0x2138 => Some(HWRegister::OAMDATAREAD),
            0x2139 => Some(HWRegister::VMDATALREAD),
            0x213a => Some(HWRegister::VMDATAHREAD),
            0x213b => Some(HWRegister::CGDATAREAD),
            0x213c => Some(HWRegister::OPHCT),
            0x213d => Some(HWRegister::OPVCT),
            0x213e => Some(HWRegister::STAT77),
            0x213f => Some(HWRegister::STAT78),
            // APU
